package com.example.ofertapp.adapter
...
class MyDrinkAdapter(
    ...
    override fun onBindViewHolder(holder: MyDrinkViewHolder, position: Int) {
        ...
        holder.txtPrice!!.text=StringBuilder("S/").append(list[position].price)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()) {
                    ...
                    userCart.child(drinkModel.key!!).updateChildren(updateData).addOnSuccessListener {
                        ...
                        cartListener.onLoadCartFailed("producto agregado con exito al carrito")
                    }
